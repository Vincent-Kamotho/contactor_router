<template>
    ...
    <div>
        ...
        <button class="btn btn-primary" type="button" @click="goAddNewContact">Add New contact</button>
        <br><br><br>
            ...
            <tr v-for="contact in contacts" :key="contact.id">
                ...
                <td>
                    <div class="btn-group" role="group">
                        <button style= "border-radius:5px;" class="btn btn-success" @click="goEditContact(contact)">Edit</button>
...
export default {
    ...
    created() {
        this.fetchContacts();
        //console.log("Vue router is visible inside list contacts", this.$router);
    },
    ...
    methods: {
        ...
        goEditContact(contact){
            this.$router.push({
                name:"contacts-edit", params:{contact}
            });
        }
